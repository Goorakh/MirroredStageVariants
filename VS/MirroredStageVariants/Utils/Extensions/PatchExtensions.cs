    ...
    public static class PatchExtensions
    {
        ...
        public static void EmitDefaultValue(this ILCursor cursor, TypeReference type)
        {
            ...
            switch (type.GetTypeCode())
            {
                ...
                case TypeCode.Decimal:
                    ...
                    cursor.Emit(OpCodes.Ldsfld, typeof(Decimal).GetField(nameof(Decimal.Zero)));
                    return;
            }
        ...
        public static TypeCode GetTypeCode(this TypeReference type)
        {
            ...
            if (resolvedType != null && resolvedType.IsEnum)
            {
                try
                {
                    underlyingType = resolvedType.GetEnumUnderlyingType();
                }
                catch
                {
                }
        ...
        static bool matchLocalIndex(int localIndex, Type variableType, ILContext ilContext)
        {
            ...
            return localIndex < ilContext.Method.Body.Variables.Count && ilContext.Method.Body.Variables[localIndex].VariableType.Is(variableType);
        }
